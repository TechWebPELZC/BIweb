...
//Select Database
$titulo = strtolower($_REQUEST['titulo']);
              if (empty($titulo)) {
                header("location: Biblioteca.php");
              } 

$sql_register = "SELECT COUNT(*) AS Total FROM b_book WHERE Titulo_Libro LIKE '%$titulo%'";
    ...
    <center>
      ...
      <ul>
        ...
        <center>
              ...
              <div id="mostrar_titulo" style="display: block;">
              <form action="buscar_titulo.php" method="get">
              <input type="text" placeholder="Titulo del Libro" name="titulo" id="titulo" class="intext" value="<?php echo $titulo; ?>" />
      ...
      <div class="paginador">
    <ul>
      <li><a href="?titulo=<?php echo $titulo; ?>&pagina=<?php echo 1;?>" class="newpage">|<</a></li>
      <li><a href="?titulo=<?php echo $titulo; ?>&pagina=<?php echo $pagina-1;?>" class="newpage"><<</a></li>
      ...
      <?php
        for ($i=1; $i <= $total_paginas; $i++) { 
          ...
          echo "<li><a href='?titulo=".$titulo."&pagina=".$i."' class='newpage'>".$i."</a></li>";
          }
        }
      ?>
      <li><a href="?titulo=<?php echo $titulo; ?>&pagina=<?php echo $pagina+1; ?>" class="newpage">>></a></li>
      <li><a href="?titulo=<?php echo $titulo; ?>&pagina=<?php echo $total_paginas; ?>" class="newpage">>|</a></li>
    </ul>
  </div>
		</section>
