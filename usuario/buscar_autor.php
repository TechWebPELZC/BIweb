...
$sql_register = "SELECT count(*) AS Total FROM b_book AS b INNER JOIN bk_autorbook ON b.ID_Libro = bk_autorbook.ID_Libro INNER JOIN b_autor AS a ON bk_autorbook.ID_Autor = a.ID_Autor WHERE bk_autorbook.ID_Autor = $autor";
      ...
      <ul>
        ...
        <li class="submenu">
          ...
          <ul class="children">
            ...
            <li><a href="../PHP/cierre.php">Cerrar sesión <span><img src="../Imagenes/cerrar-sesion.png"></span></a></li>
          </ul>
        </li>
        ...
        <center>
              ...
              <input type="submit" value="Buscar" class="btn_search" />
                ...
                <div id="mostrar_categoria" style="display: none;">
          ...
          <div id="mostrar_autor" style="display: block;">
            ...
            <?php
              if($result3->num_rows > 0){
                while ($row3 = $result3->fetch_assoc()) {
                  if ($autor == $row3['ID_Autor']) {
            ?>
            <option value="<?php echo $row3['ID_Autor']; ?>" selected><?php echo $row3['Autor']; ?></option>
            <?php 
                  } else { 
            ?>
...
<div class="paginador">
  <ul>
    <li><a href="?autor=<?php echo $autor; ?>&pagina=<?php echo 1;?>" class="newpage">|<</a></li>
    <li><a href="?autor=<?php echo $autor; ?>&pagina=<?php echo $pagina-1;?>" class="newpage"><<</a></li>
    ...
    <?php
      for ($i=1; $i <= $total_paginas; $i++) { 
        ...
        echo "<li><a href='?autor=".$autor."&pagina=".$i."' class='newpage'>".$i."</a></li>";
        }
      }
    ?>
    <li><a href="?autor=<?php echo $autor; ?>&pagina=<?php echo $pagina+1; ?>" class="newpage">>></a></li>
    <li><a href="?autor=<?php echo $autor; ?>&pagina=<?php echo $total_paginas; ?>" class="newpage">>|</a></li>
  </ul>
</div>
		</section>
