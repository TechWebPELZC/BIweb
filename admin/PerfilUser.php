        ...
        <li class="submenu">
          ...
          <section class="contenido">
              <br>
               ...
               <center><table>
                    <tr>
                         <th><a class="boton_personalizado" href="../PHP/editarperfil.php?id=<?php echo $_SESSION['usuario']['ID_User'];?>"><span class="icon-cogs"> Editar información</span></a></th>
                         <th><a class="boton_personalizado" href="../PHP/editarcontraseña.php?idc=<?php echo $_SESSION['usuario']['ID_User'];?>"><span class="icon-unlocked"> Cambiar contraseña</span></a></th>
                    </tr>
               </table></center>
