...
if($result->num_rows > 0){
	while($row = $result->fetch_assoc()){
        ...
        <td><center><input type="button" class="btn_table" onClick="deleteme(<?php echo $row['ID_Idioma']; ?>)" name="Delete" value="Eliminar"></center></td>
        </tr>
		...
		function deleteme(delid)
		{
			if(confirm('¿Desea eliminar este libro de la base de datos?')){
				window.location.href='../../PHP/delete_idioma.php?del_id=' +delid+'';
				return true;
			}
		}		
		</script>
