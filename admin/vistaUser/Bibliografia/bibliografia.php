                 ...
                 <div class="wrapper">
                    <div class="logo"><img src="../../../Imagenes/Logo.png"></div>
                      ...
                      <tr>
                        ...
                        <th class="sesion" width = "10" height="10"><a href="../../LibrosAdmin.php" title="Regresar a Vista Admin"><img src="../../../Imagenes/regresar.png" width="30" height="30"></a></th>
                      </tr>
                    </table>
                    <nav>
						<a href="../InicioU.php"><span class="icon-home3"></span> Inicio</a>
						<a href="../Biblioteca.php"><span class="icon-books"></span> Biblioteca</a>
					</nav>
                </div>
          </header>
        <br>
        <br> -->
          ...
          ?></center>
          	...
          	<div class="table-container">
				...
				<br>
				<center><a href="../Biblioteca.php" class="boton_1">Regresar</a></center>
          </section>
